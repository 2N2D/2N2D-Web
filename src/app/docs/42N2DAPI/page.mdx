...
- Un genom este compus din:
  ...
  - Fitness (scorul de performanță) După evaluarea generației inițiale, genomurile sunt grupate în specii în funcție de similaritate, iar cele mai bune au șanse mai mari de recombinare.
...
Toate requesturile care ajung în API sunt mai întâi verificate. Se extrag datele din header și se caută componenta `x-api-key`. Aceasta este, de fapt, un _hash_ al unei chei stocate pe serverul aplicației web.
