...
import {getUser, User, updateUser} from "@/lib/sessionHandling/sessionManager";
...
export default function Profile() {
    ...
    async function updateName(e: React.FormEvent<HTMLFormElement>) {
        ...
        const updatedUser = {...user, displayName: formData.get("username")?.toString()!};
            ...
            <div className={"profileArea"}>
                ...
                {user ? (
                    <form onSubmit={updateName}>
                        ...
                        <input className={"subtitle"} type={"text"} defaultValue={user.displayName!} name={"username"}/>
                ...
                <button onClick={handleLogout} className={"logoutBut"}>Logout <i
